...
describe('Database', () => {
  ...
  describe('Save & update Parcel Data', () => {
    it('should save Parcel', async () => {
      ...
      expect(
        res.toString(),
        'expect parcel data to be saved'
      ).to.be.equal(({ ipns, ipfs, dependencies }).toString())
    })
    ...
    it('should update Parcel', async () => {
      ...
      await Database.setParcel({ x, y }, { ipns, ipfs, dependencies: ['dependency1'] })
  ...
  describe('Save & Update IPFS', () => {
    ...
    it('should update IPFS', async () => {
      ...
      expect(
        res,
        'expect IPFS data to be updated'
      ).to.be.equal('newIPFShash')
    })
  })
})
